...
export default class ProductForm {
  ...
  #onUploadImageButtonClick = () => {
    ...
    fileInput.onchange = async () => {
      ...
      try {
        ...
        this.#subElements.imageList.append(this.createElement(this.getImageTemplate(uploadedImage.link, image.name)));
      } catch (e) {
  ...
  async loadProduct() {
    ...
    product.images.forEach(image => {
      this.#subElements.imageList.append(this.createElement(this.getImageTemplate(image.url, image.source)));
    });
  }
